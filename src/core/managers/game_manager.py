...
class GameManager:
    ...
    def try_switch_map(self) -> None:
        if self.should_change_scene:
            ...
            self.should_change_scene = False
            if self.player:
                self.player.position.x = round(self.maps[self.current_map_key].spawn.x // GameSettings.TILE_SIZE) * GameSettings.TILE_SIZE # Updated
                self.player.position.y = round(self.maps[self.current_map_key].spawn.y // GameSettings.TILE_SIZE) * GameSettings.TILE_SIZE # Updated
